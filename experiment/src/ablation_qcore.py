...
BATCH_SIZE = 128
TA_OUTPUT_CSV_FILE = "ta_rag_org_ablation_coreQ_70b_batch_faiss_flat_results.csv"
TA_OUTPUT_ACCURACY_TXT_FILE = "ta_rag_org_ablation_coreQ_70b_batch_faiss_flat_accuracy_summary.txt"
