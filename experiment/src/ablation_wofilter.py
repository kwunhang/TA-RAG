...
TA_OUTPUT_CSV_FILE = "ta_rag_org_ablation_wofilter_70b_batch_faiss_flat_results.csv"
TA_OUTPUT_ACCURACY_TXT_FILE = "ta_rag_org_ablation_wofilter_70b_batch_faiss_flat_accuracy_summary.txt"
...
def rank_candidates_semantically(query_embedding: np.ndarray,
    ...
    if candidate_faiss_ids:
        ...
        distances, indices = faiss_index.search(query_embedding.ravel().reshape(1, -1), top_k)
...
if __name__ == "__main__":
    ...
    # TEST_DATA_FILE = 'MCQA/dqabench_mcqa/dqabench_mcqa_eval_set.json'
