...
from tools.tsretriever.embedding import ContrieverEmbedder
...
EMBED_MODEL_NAME = "TS-contriever"
FAISS_INDEX_FILE = "index/TSRetriever_rag_hnsw.faissindex"
METADATA_FILE = "index/TSRetriever_rag_metadata.json"
BATCH_SIZE = 128
OUTPUT_CSV_FILE = "TSRetriever_70b_batch_faiss_hnsw_results.csv"
OUTPUT_ACCURACY_TXT_FILE = "TSRetriever_70b_batch_faiss_hnsw_accuracy_summary.txt"
...
try:
    ...
    EMBED_MODEL = ContrieverEmbedder("TS-retriever/Tscontriever")
...
def search_faiss_hnsw(faiss_index, query_text, metadata_store, top_k=10):
    ...
    try:
        search_param = faiss.SearchParametersHNSW(efSearch=top_k+20)
